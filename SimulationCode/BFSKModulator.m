%> @brief BFSK high-speed HD modulator/demodulator
classdef BFSKModulator < modulatorClass
    %
    ...
    methods
        ...
        %> before sending
        function obj = BFSKModulator(fullDuplex,CSMA)
            packetLength = 1206;
            topBitrate = (10e3*2*packetLength/(2047*1.2))*1.2*0.5;
            preambleCollisionFatal = false;
            centerFrequency = 25e3;
            maxBandwidth = 10e3;
            interferenceMitigation = -8;   %in dB - interference in BFSK is very bad
