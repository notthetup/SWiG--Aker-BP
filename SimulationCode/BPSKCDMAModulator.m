%> @brief BPSKCDMA high-speed HD modulator/demodulator
classdef BPSKCDMAModulator < modulatorClass
    %
    ...
    methods
        ...
        %> before sending
        function obj = BPSKCDMAModulator(fullDuplex,CSMA)
            packetLength = 1206;
            preambleCollisionFatal = false;
            centerFrequency = 25e3;
            maxBandwidth = 10e3;
            interferenceMitigation = 20;   %in dB - highly resistant
            nominalPreambleDuration = 127*1.2/maxBandwidth;
            topBitrate = maxBandwidth/(1.2*127);
