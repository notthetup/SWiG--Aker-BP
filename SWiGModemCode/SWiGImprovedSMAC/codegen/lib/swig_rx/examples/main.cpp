...
static coder::array<real_T, 2U> argInit_Unboundedxd2_real_T();
static char_T argInit_char_T();
static real_T argInit_real_T();
static void argInit_struct0_T(SWiG_rx_namespace::struct0_T *result);
...
{
  SWiG_rx_namespace::SWiG_rx_class *classInstance;
  classInstance = new SWiG_rx_namespace::SWiG_rx_class;

  // Invoke the entry-point functions.
  // You can call entry-point functions multiple times.
  main_swig_rx(classInstance);
  delete classInstance;
  return 0;
}

void main_swig_rx(SWiG_rx_namespace::SWiG_rx_class *instancePtr)
{
  coder::array<real_T, 2U> signalIn;
  SWiG_rx_namespace::struct0_T params;
  SWiG_rx_namespace::struct1_T pkt;
  SWiG_rx_namespace::struct2_T state;
  real_T Rate_value_tmp;

  // Initialize function 'swig_rx' input arguments.
  Rate_value_tmp = argInit_real_T();

  // Initialize function input argument 'params'.
  argInit_struct0_T(&params);

  // Initialize function input argument 'signalIn'.
  signalIn = argInit_Unboundedxd2_real_T();

  // Call the entry-point 'swig_rx'.
  instancePtr->swig_rx(Rate_value_tmp, Rate_value_tmp, &params, signalIn, &pkt,
                       &state);
}
